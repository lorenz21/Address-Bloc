...
describe("ContactController", () => {
    ...
    describe("#getContacts", () => {
        it("should return an empty array when there are no contacts", (done) => {
        ...
        it("should return an array of contacts when contacts are availabe", (done) => {
          this.book.addContact("Alice", "111-222-3333", "alice@hotmail.com")
          .then(() => {
            this.book.getContacts()
            .then((contacts) => {
    ...
    describe("search methods", () => {
      ...
      const zelda = ["Zelda Smith", "000-100-1113", "zelda@nintendo.com"];
      const snake = ["Solid Snake", "100-100-1004", "snake@konami.com"];
      const magus = ["Magus Johnson", "101-010-1013", "magus@squaresoft.com"];
      const alloy = ["Alloy Rodriguez", "111-111-1112", "allow@guerrilla-games.com"];
          ...
          .then(() => {
            ...
            .then(() => {
              ...
              .then((contacts) => {
                ...
                expect(contact.phone).toBe("101-010-1013");
        ...
        it("should return the contact when found", (done) => {
          ...
          .then(() => {
            ...
            .then((contact) => {
              ...
              expect(contact.phone).toBe("100-100-1004");
